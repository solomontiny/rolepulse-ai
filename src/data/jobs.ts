...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    demandTrend: "stable",
    automationRisk: "medium",
    summary: "Analyzes business processes and operational data to improve efficiency. AI tools are automating routine analysis but strategic operations thinking remains essential.",
    avgSalary: "$78K",
    growthRate: "+15%",
    skillsToStayRelevant: ["Process automation design", "Data storytelling", "AI-driven forecasting", "Cross-functional collaboration"],
    recommendedAITools: ["Tableau AI", "Power BI Copilot", "Alteryx", "Celonis"],
    careerOutlook: "Routine reporting roles shrinking, but analysts who can design and optimize AI-augmented processes are increasingly valuable to organizations scaling efficiency.",
  },
  {
    ticker: "SLEX",
    ...
    demandTrend: "stable",
    automationRisk: "medium",
    summary: "Drives revenue through relationship building and deal closing. AI enhances prospecting and CRM insights, but complex B2B sales still depend on human persuasion and trust.",
    avgSalary: "$95K",
    growthRate: "+10%",
    skillsToStayRelevant: ["AI-powered prospecting", "Consultative selling", "Data-driven pipeline management", "Social selling"],
    recommendedAITools: ["Gong", "Outreach", "Salesforce Einstein", "Apollo.io"],
    careerOutlook: "Transactional sales declining due to self-serve AI. Enterprise and consultative sales roles remain strong. Top performers who leverage AI tools will widen the gap.",
  },
  {
    ticker: "BSAN",
    ...
    demandTrend: "stable",
    automationRisk: "medium",
    summary: "Translates business needs into technical requirements and data insights. AI automates data gathering and basic analysis, shifting the role toward strategic advisory.",
    avgSalary: "$88K",
    growthRate: "+18%",
    skillsToStayRelevant: ["AI requirements gathering", "Stakeholder management", "Process modeling with AI", "Agile methodology"],
    recommendedAITools: ["Jira AI", "Confluence AI", "Notion AI", "Lucidchart"],
    careerOutlook: "Traditional BA tasks being absorbed by AI, but demand for BAs who bridge AI capabilities with business strategy is growing. Hybrid technical-business skills are key.",
  },
];
